...
exports.BookingService = exports.generateBookingId = exports.findLastBookingId = exports.asyncForEach = void 0;
...
const findLastBookingId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastBooking = yield booking_model_1.Booking.findOne({
        ...
        .lean();
    return (lastBooking === null || lastBooking === void 0 ? void 0 : lastBooking.id) ? lastBooking.id.substring(8) : undefined;
});
exports.findLastBookingId = findLastBookingId;
const generateBookingId = () => __awaiter(void 0, void 0, void 0, function* () {
    const currentId = (yield (0, exports.findLastBookingId)()) || (0).toString().padStart(5, '0');
...
const createBooking = (booking) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, exports.asyncForEach)(serviceIDs, (serviceId) => __awaiter(void 0, void 0, void 0, function* () {
...
const confirmBooking = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const booking = yield booking_model_1.Booking.findOne({ _id: new mongoose_1.Types.ObjectId(id) });
    if (!booking) {
        return null;
    }
    ...
    if (customer) {
        ...
        (_c = customer === null || customer === void 0 ? void 0 : customer.booking) === null || _c === void 0 ? void 0 : _c.push(booking._id.toString());
        (_d = customer === null || customer === void 0 ? void 0 : customer.notification) === null || _d === void 0 ? void 0 : _d.push({
            message: `Your booking is confirmed by Admin: ${booking === null || booking === void 0 ? void 0 : booking.adminID} please check`,
        });
        yield customer.save();
    }
    return booking;
...
const getSingleBooking = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield booking_model_1.Booking.findOne({ id: id })
...
const updateBooking = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield booking_model_1.Booking.findOneAndUpdate({ id: id }, payload, {
        new: true,
    });
    return result;
});
const deleteBooking = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const service = yield booking_model_1.Booking.findOneAndDelete({ id: id });
    return service;
});
