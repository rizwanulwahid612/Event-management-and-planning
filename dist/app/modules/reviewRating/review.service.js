...
const createReview = (review) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield category_model_1.Category.updateOne({ _id: review.categoryId }, { $push: { reviewIds: result._id } });
    return result;
});
...
const getReviewByCategory = (id) => __awaiter(void 0, void 0, void 0, function* () {
