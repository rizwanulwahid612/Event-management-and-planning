...
router.get(
  ...
  customer_controller_1.CustomerController.getSingleCustomer,
);
router.get(
  '/',
  (0, auth_1.default)(
  ...
  customer_controller_1.CustomerController.getAllCustomers,
);
router.patch(
  '/:id',
  (0, validateRequest_1.default)(
    customer_validations_1.CustomerValidation.updateCustomer,
  ),
  (0, auth_1.default)(
    user_1.ENUM_USER_ROLE.SUPER_ADMIN,
    user_1.ENUM_USER_ROLE.ADMIN,
...
router.delete(
  ...
  customer_controller_1.CustomerController.deleteCustomer,
);
