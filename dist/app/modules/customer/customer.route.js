...
//ENUM_USER_ROLE.ADMIN,
//ENUM_USER_ROLE.CUSTOMER,
customer_controller_1.CustomerController.createCustomer);
router.get('/:id', (0, auth_1.default)(
//ENUM_USER_ROLE.SUPER_ADMIN,
user_1.ENUM_USER_ROLE.ADMIN, user_1.ENUM_USER_ROLE.CUSTOMER), customer_controller_1.CustomerController.getSingleCustomer);
...
router.delete('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN), customer_controller_1.CustomerController.deleteCustomer);
