...
const createCustomer = (post) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateCustomer = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Customer is not found !');
    }
    ...
    const result = yield customer_model_1.Customer.findOneAndUpdate({ id }, updatedCustomerData, {
        new: true,
    });
    return result;
});
