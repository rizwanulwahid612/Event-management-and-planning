    ...
    for (const customer of customers) {
      ...
      (_a =
        customer === null || customer === void 0
          ? void 0
          : customer.notification) === null || _a === void 0
        ? void 0
        : _a.push({ message: notificationMessage });
      yield customer.save();
    }
    return result;
  });
const getSinglePost = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield post_model_1.Post.findOne({ _id: id }).populate(
      'adminId',
    );
    return result;
  });
const getAllPosts = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updatePost = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield post_model_1.Post.findOneAndUpdate(
      { _id: id },
      payload,
      {
        new: true,
