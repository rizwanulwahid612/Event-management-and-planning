...
const findLastCategoryId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastCategory = yield category_model_1.Category.findOne(
      ...
      .lean();
    return (
      lastCategory === null || lastCategory === void 0
        ? void 0
        : lastCategory.id
    )
      ? lastCategory.id.substring(9)
      : undefined;
  });
...
const generateCategoryId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const currentId =
      (yield (0, exports.findLastCategoryId)()) ||
...
const getAllCategories = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield category_model_1.Category.find(whereConditions)
      ...
      .limit(limit);
    const total =
      yield category_model_1.Category.countDocuments(whereConditions);
    return {
      meta: {
        page,
        limit,
...
const updateCategory = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield category_model_1.Category.findOneAndUpdate(
      { _id: id },
      payload,
      {
        new: true,
