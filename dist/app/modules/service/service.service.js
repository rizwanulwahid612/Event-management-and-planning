...
exports.ServiceService = exports.generateServiceId = exports.findLastServiceId = exports.asyncForEach = void 0;
...
const findLastServiceId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastService = yield service_model_1.Service.findOne({
        ...
        .lean();
    return (lastService === null || lastService === void 0 ? void 0 : lastService.id) ? lastService.id.substring(8) : undefined;
});
exports.findLastServiceId = findLastServiceId;
const generateServiceId = () => __awaiter(void 0, void 0, void 0, function* () {
    const currentId = (yield (0, exports.findLastServiceId)()) || (0).toString().padStart(5, '0');
...
const createService = (service) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, exports.asyncForEach)(categoryIds, (categoryId) => __awaiter(void 0, void 0, void 0, function* () {
        const alreadyExist = yield service_model_1.Service.findOne({ categoryIds: categoryId });
...
const getSingleService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield service_model_1.Service.findOne({ _id: id }).populate('categoryIds');
    return result;
});
...
const deleteService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const service = yield service_model_1.Service.findOneAndDelete({ _id: id });
    return service;
});
