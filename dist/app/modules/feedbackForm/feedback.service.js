...
const getSingleFeedback = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield feedback_model_1.Feedback.findOne({
      _id: id,
    }).populate('customerId');
    return result;
  });
const getAllFeedbacks = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield feedback_model_1.Feedback.find(whereConditions)
      ...
      .limit(limit);
    const total =
      yield feedback_model_1.Feedback.countDocuments(whereConditions);
    return {
      meta: {
        page,
        limit,
...
const updateFeedback = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield feedback_model_1.Feedback.findOneAndUpdate(
      { _id: id },
      payload,
      {
        new: true,
...
const deleteFeedback = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield feedback_model_1.Feedback.findOneAndDelete({
      _id: id,
    });
    return result;
  });
