...
const getAllNotifications = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateNotification = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notification_model_1.Notification.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
const deleteNotification = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notification_model_1.Notification.findOneAndDelete({ _id: id });
    return result;
});
