...
const getSingleNotification = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result =
      yield notification_service_1.NotificationService.getSingleNotification(
        id,
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const getAllNotifications = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateNotification = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const updatedData = req.body;
    const result =
      yield notification_service_1.NotificationService.updateNotification(
        id,
        updatedData,
      );
    (0, sendResponse_1.default)(res, {
...
const deleteNotification = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result =
